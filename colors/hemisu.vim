...
if version >= 700
  ...
  call s:h("MatchParen",  { "fg": s:accent1, "bg": s:faint, "gui": "NONE" })
...
call s:h("StatusLine",   { "fg": s:norm, "bg": s:faint, "gui": "NONE", "cterm": "NONE" })
...
call s:h("TabLineSel",   { "gui": "NONE", "cterm": "NONE" })
call s:h("Folded",       { "fg": s:comment, "bg": s:faint })
call s:h("Directory",    { "fg": s:accent1 })
call s:h("Title",        { "fg": s:accent4, "gui": "NONE", "cterm": "NONE" })
...
call s:h("DiffText",     { "bg": s:faintRed, "gui": "NONE", "cterm": "NONE" })
...
call s:h("Keyword",    { "fg": s:accent2, "gui": "NONE", "cterm": "NONE" })
call s:h("Todo",       { "fg": s:normRed, "gui": "NONE", "cterm": "NONE" })
call s:h("Function",   { "gui": "NONE", "cterm": "NONE" })
